<template>
    <section>
        <div class="max-w-5xl m-auto py-8 px-4">
            <div class="flex items-center 710px:items-start justify-between py-[120px] 710px:flex-col">
                <div class="py-2 710px:order-2">
                    <h1 class="text-6xl font-semibold text-light mb-6 410px:text-4xl 410px:leading-[50px]">Next <br> Generation <br>Rust Support</h1>
                    <div class="flex">
                        <p class="text-dark-gray text-2xl">Create custom commands to broadcast <br> messages in server. <Icon name="teenyicons:shield-tick-outline" class="ml-1 text-2xl text-[#4BCC14]" /></p>
                    </div>
                </div>
                <div class="img-bg 710px:order-1 mb-6">
                    <img src="~/assets/images/rust_logo.jpg" alt="Rust Cobal Scientist" class="max-w-[300px]">
                </div>
            </div>
            <div class="grid grid-cols-2 gap-6 mb-6 570px:grid-cols-1">
                <div class="bg-light-gray p-6 rounded-lg">
                    ...
                    <p class="text-gray-400 text-sm">RustyGuard is an open-source bot. You can look at the code and contribute to make it better.</p>
                </div>
                <div class="bg-light-gray p-6 rounded-lg">
                    <Icon name="ooui:link-secure" class="p-3 text-[50px] rounded-md bg-dark text-white mb-2"  />
                    <h2 class="text-gray-200 text-2xl mb-2 font-semibold">Secure</h2>
                    <p class="text-gray-400 text-sm">It is secure abot because you never give admin permission. Create your own bot out or contribute.</p>
                </div>
            </div>
            <div class="py-6">
                <h2 class="text-4xl text-white font-semibold my-3">How to make it work?</h2>
