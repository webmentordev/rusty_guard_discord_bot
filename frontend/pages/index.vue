    ...
    <section>
        <div class="max-w-5xl m-auto py-8 px-4">
            <div class="flex items-center justify-between py-[120px]">
                <div>
                    <h1 class="text-6xl font-semibold text-light mb-6">Next <br> Generation <br>Rust Support</h1>
                    <div class="flex">
            ...
            <div class="grid grid-cols-2 gap-6 mb-6">
                ...
                <div class="bg-light-gray p-6 rounded-lg">
                    ...
                    <p class="text-gray-400 text-sm">It is secure because you can look at the code. Create your own bot out or contribute.</p>
                </div>
            </div>
            <div class="py-6">
